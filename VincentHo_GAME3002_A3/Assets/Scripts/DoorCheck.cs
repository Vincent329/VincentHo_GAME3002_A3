...
public class DoorCheck : MonoBehaviour
{
    ...
    [SerializeField] private DoorScript m_Door; // getting the door tied to this check
    [SerializeField] private PlayerMovement m_Player; // to access the key value of the player

    [SerializeField] private TextMeshProUGUI KeyText;
    [SerializeField] private bool m_IsInArea;
